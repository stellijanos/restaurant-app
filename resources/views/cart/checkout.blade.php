...
<div id="checkout-div">
    <div id="checkout">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="delivery-type" id="delivery" value="delivery" checked onclick="cart.updateCheckoutShippingFee(this)">
        ...
        <a href="{{route('show_checkout')}}"><button class="btn btn-secondary">Proceed to checkout >></button></a>
    </div>
</div>
