...
<div class="item">
    ...
    <div class="details-options">
        <div class="name-quantity">
            <p style="font-weight:bold; font-size:1.3rem; margin-bottom:5px; width:150px; text-align:center;" class="text-truncate">{{$food->name}}</p>
            <div class="set-quantity-div">
                ...
                <p name="quantity" value="1" style="margin-bottom:5px" id="text-quantity-{{$food->id}}">{{$cookie_cart[$food->id] ?? 0 }}</p>
