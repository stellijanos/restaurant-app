<div class="modal fade" id="edit-menu-item-{{$food->id}}" tabindex="-1" aria-labelledby="edit-menu-item-label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <form class="modal-content" action="{{route('update_menu_item', ['id' => $food->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
                <div class="food-image mb-3">
                    <img src="{{asset('/storage/app/public/images/menu_items').'/'.$food->image}}" class="img-fluid" height="400" width="400" alt="{{$food->name}}">
                </div>
